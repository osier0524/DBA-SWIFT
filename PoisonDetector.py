...
class SequnceDataset(Dataset):
    def __init__(self, root_dirs, is_train=True, is_binary=True, test_ratio=0.2, random_seed=0):
        self.files = []
        self.file_labels = []
...
def run():
    ...
    train_dataset = SequnceDataset(root_dirs, is_train=True, is_binary=True)
    test_dataset = SequnceDataset(root_dirs, is_train=False, is_binary=True)
