...
# 20
mpirun -np 20 python Train.py --config Config/swift-iid.yaml --randomSeed 100
...
# adversary 0  pattern 1  clients 8
mpirun -np 8 python Train.py --config Config/swift-iid-8-pattern1.yaml --randomSeed 100